    ...
    if request.method == "POST":
        ...
        if response.status_code == requests.codes["ok"]:
            ...
            if opinions_count:
                ...
                #proces eksdtrakcjisall_opinions = []
                ...
                while (url):
                    ...
                    product={
                        ...
                        'avarage_rating': opinions.rating.mean(),
                        'rating_distribution': opinions.rating.value_counts().sort_index().reindex(np.arange(0,5.5,0.5), fill_value = 0).to_dict(),
